...
if ((typeof process !== 'undefined' && process.title !== 'browser') || typeof __webpack_require__ !== 'function') {
  ...
  protocols.tt = require('./tt')
  protocols.tts = require('./tt')

  protocols.swan = require('./swan')
  protocols.swans = require('./swan')
}
...
function connect (brokerUrl, opts) {
  ...
  if (opts.cert && opts.key) {
    if (opts.protocol) {
      if (['mqtts', 'wss', 'wxs', 'alis', 'tts', 'swans'].indexOf(opts.protocol) === -1) {
  ...
  if (!protocols[opts.protocol]) {
    ...
    opts.protocol = ['mqtt', 'mqtts', 'ws', 'wss', 'wx', 'wxs', 'ali', 'alis', 'tt', 'tts', 'swan', 'swans'].filter(
      function (key, index) {
